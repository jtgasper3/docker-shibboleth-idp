...
RUN set -x; \
    ...
    wget -O jetty.zip "https://eclipse.org/downloads/download.php?file=/jetty/stable-9/dist/jetty-distribution-$jetty_version.zip&r=1" \
    && echo "cdfa0cd79c2714d9b8b8db2bfec527dc86f895b1  jetty.zip" | sha1sum -c - \
